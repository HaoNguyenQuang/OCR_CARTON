...
namespace PdfiumViewer
{
    public abstract class PanningZoomingScrollControl : CustomScrollControl
    {
        ...
        private Point _dragCurrent; // Điểm chuột khi di chuyển (MouseMove)
        private Point _dragEnd;    // Điểm cuối khi thả chuột (MouseUp)
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (!Capture)
                return;
            //checkKey = (Control.ModifierKeys) == Keys.Shift;
